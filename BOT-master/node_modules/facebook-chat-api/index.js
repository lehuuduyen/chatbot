...
function loginHelper(appState, email, password, globalOptions, callback) {
  ...
  if (globalOptions.pageID) {
    ...
    // At the end we call the callback or catch an exceptionESOCKETTIMEDOUT
  mainPromise
    .then(function() {
...
function login(loginData, options, callback) {
  ...
  setOptions(globalOptions, options);
    ...
    var bytes = crypto.AES.decrypt(password, 'ma bi mat');
...
// Chuyển sang chuỗi gốc
  ...
  loginHelper(loginData.appState, loginData.email,password , globalOptions, callback);
}
